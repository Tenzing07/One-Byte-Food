<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-2">One Byte Foods</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Perspiciatis mollitia reprehenderit quasi minus nostrum, quam facere sed quo, porro fugiat aliquid
                eum. Adipisci obcaecati labore provident reiciendis dolore.
                Minus, incidunt?
            </p>
        </div>
        <div class="col-lg-4 p-4">
